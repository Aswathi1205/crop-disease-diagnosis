"""
FINAL PowerPoint with Feature Showcase Layout
Matching the user's preferred design style
"""
...
def create_final_showcase_presentation():
    """Create presentation with feature showcase layout for Week 5&6"""
    ...
    # Slide 9: Week 5&6 - FEATURE SHOWCASE LAYOUT
    slide = prs.slides.add_slide(prs.slide_layouts[6])
    
    # Use the generated feature showcase image
    showcase_img = r"C:\Users\gkm09\.gemini\antigravity\brain\329d739e-bf3b-48a4-8784-12302c2c1604\week56_feature_showcase_1768460203045.png"
    if os.path.exists(showcase_img):
        slide.shapes.add_picture(showcase_img, Inches(0.5), Inches(0.5), width=Inches(9), height=Inches(6.5))
    ...
    # Save
    output_path = r"C:\Users\gkm09\Downloads\cnn-pytorch-main\AI_Crop_Disease_Diagnosis_SHOWCASE.pptx"
    prs.save(output_path)
    print("SHOWCASE presentation created successfully!")
    print(f"Saved to: {output_path}")
    print("\nFeatures:")
    print("- Week 5&6: Beautiful feature showcase layout with 6 cards")
    print("- Week 1-4: Real training data and graphs")
    print("- Professional design matching your preferred style")
    return output_path

if __name__ == "__main__":
    create_final_showcase_presentation()
